...
ARG HUGO_SHA=541467720a7af3a98deb5cd66dac2dc2a8452edea133bd8d7e8e5f937a375229
ARG HUGO_EXTENDED_SHA=8efea63ab960a91918a4c6131d10c244635cd983e4d083afdba6c6b99edb55b6
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
