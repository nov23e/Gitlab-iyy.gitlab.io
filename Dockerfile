...
ARG HUGO_SHA=c7ce404adf0895d914c023846093853777601b0a299ad37e04d35c8675ceafd3
ARG HUGO_EXTENDED_SHA=05103c182c92d0720eef8032910f9d42fc61f33cd50a46c0eb857b9142a58808
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
