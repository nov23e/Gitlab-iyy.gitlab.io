...
ARG HUGO=hugo
ARG HUGO_VERSION=0.97.1
ARG HUGO_SHA=59ad41fa261591a97e572272341841280f728f28fbf860c3d21f50d3aff3edef
ARG HUGO_EXTENDED_SHA=58d0e7ea1e0f86d0652910bf9be958f53eba0433eab90fe5c6e38236ca2b564f
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
