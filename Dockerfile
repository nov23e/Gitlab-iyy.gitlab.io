...
ARG HUGO_SHA=69223e82aeaf1bcf99e85c1139b0c409cd68f140ffb073be050d079e7308f1fe
ARG HUGO_EXTENDED_SHA=4eacd26605460eee3935d31d52e1bad068f0bdb9c73fe7b5a0296beede52a264
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
