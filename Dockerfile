...
ARG HUGO_SHA=ed2dfaed35a2100dab550c986689820e0a5d5b514cc106ac2eae341dc43030d3
ARG HUGO_EXTENDED_SHA=d771e2d3edc4a708bc8272954d087bbfa99aea55bc816e40e6b0589a7b966f65
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
