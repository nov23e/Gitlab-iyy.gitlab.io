...
ARG HUGO_SHA=eda04c0497f7d2dae55da51a3fb5bbfc7d0a0dd8032cdee9093252aa6d566527
ARG HUGO_EXTENDED_SHA=e493b819c77b4f3af6b5ac4635c49311adc24a4ada109bd87452fb8bf5bef9ca
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
