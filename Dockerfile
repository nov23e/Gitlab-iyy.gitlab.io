...
ARG HUGO_SHA=4250a77a3a0cfb3096c54200de6203b5db8b2ffde4aaf3cbb08edbcf01ba3c1b
ARG HUGO_EXTENDED_SHA=84e2ef0a17f72261999d494b22ae24fa2cf9da4d6b2d524dba21b3ed0ed7004c
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
