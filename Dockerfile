...
ARG HUGO_SHA=7da50efc00ca59e5fda06468751045271bbdc3b5f504a3824e3af2d5e04fb7cd
ARG HUGO_EXTENDED_SHA=b514bdaa2d049456076d87f82a7a443f4a2694a58000a309df2e59a32776f2ec
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
