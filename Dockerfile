...
ARG HUGO=hugo
ARG HUGO_VERSION=0.93.1
ARG HUGO_SHA=a164d2bd090c429dde936e927190580194a0840fe61bb4644d29c04f307351c4
ARG HUGO_EXTENDED_SHA=910ac0dbfd4f66fe192cf3d1b914cf66e56896e6d2ebd1cef2a66a2ddcebea01
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
