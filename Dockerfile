...
ARG HUGO=hugo
ARG HUGO_VERSION=0.68.0
ARG HUGO_SHA=252a4edebff79d9a154cf286390d3873a9a90d43d702f8e50621163706a61365
ARG HUGO_EXTENDED_SHA=fd83152633154a201831cd74837621aa0d4a3bf3e2c4a46931091e2ecd59c986
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
