...
ARG HUGO_SHA=4a4072150791e2b0d0b60b408775c7feb33cf95a888be200dffabab56cb48b7a
ARG HUGO_EXTENDED_SHA=b540d7ec33366f52900f60b4ab3d08a0536222e16f2582819498dc034d69087c
RUN set -eux && \
    case ${HUGO} in \
      *_extended) \
